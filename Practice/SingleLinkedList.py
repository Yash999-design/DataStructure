...
class SingleLinkedList:
    ...
    def remove_cycle(self):
        ...
        print(f"Node at which cycle the cycle was detected : {c.info}")
        ...
        print(f"Length of the cycle is : {len_cycle}")
        ...
        print(f"Nodes remaining in the list is {len_remain_cycle}")

        list_length = len_cycle + len_remain_cycle
    ...
    def _merge_sort_rec(self, list_start):
        ...
        start1 = list_start
        start2 = self._divide_list(start1)
